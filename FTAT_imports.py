...
def get_param_group(filepath, filetype, raw_data, in_map_groups):
    ...
    if 'FPQA' in filepath:
        ...
        FXZI_dict['NxC_EU'] = 'structures'
        FXZI_dict['NyC_EU'] = 'structures'
        FXZI_dict['NzC_EU'] = 'structures'
        FXZI_dict['NxL_EU'] = 'structures'
        FXZI_dict['NyL_EU'] = 'structures'
        FXZI_dict['NzL_EU'] = 'structures'
        FXZI_dict['NxR_EU'] = 'structures'
        FXZI_dict['NyR_EU'] = 'structures'
        FXZI_dict['NzR_EU'] = 'structures'
